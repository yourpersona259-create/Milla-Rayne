...
export default function ChatInterface() {
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full max-w-xl min-h-[70vh] bg-white/80 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden">
        {/* Top Bar with Action Buttons */}
        <div className="flex justify-center items-center p-4 border-b border-gray-200 bg-transparent">
        ...
        {/* Input Area */}
        <div className="p-4 border-t border-gray-200 bg-transparent">
